...
Create a new instance. You may also provide an 'apiurl' item to change the url 
that is queried (default is http://api.discogs.com).
...
Returns a L<WWW::Discogs::Release> object. You can get a $release_id from a
...
Returns a L<WWW::Discogs::Artist> object. You can get the exact name of an
...
Returns a L<WWW::Discogs::Master> object. You can get a $master_id from a
search or release.
